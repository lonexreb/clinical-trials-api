...
async def seed_trials(db_session: AsyncSession) -> list[Trial]:
    ...
    trials = [
        Trial(
            ...
            references=[{"pmid": "12345678", "type": "RESULT", "citation": "Smith et al. 2023"}],
            investigators=[{"name": "Dr. Smith", "role": "PRINCIPAL_INVESTIGATOR", "affiliation": "Hospital A"}],
        ...
        Trial(
            ...
            eligibility_criteria="Inclusion: Diagnosed with hypertension",
            mesh_terms=["Hypertension", "Heart Failure"],
            references=[{"pmid": "87654321", "type": "BACKGROUND", "citation": "Jones et al. 2022"}],
            investigators=[{"name": "Dr. Jones", "role": "PRINCIPAL_INVESTIGATOR", "affiliation": "Hospital C"}],
